-- 创建数据库（如果不存在）
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = 'creator_platform')
BEGIN
    CREATE DATABASE creator_platform;
    PRINT N'数据库 creator_platform 创建成功';
END
ELSE
BEGIN
    PRINT N'数据库 creator_platform 已存在';
END
GO
...
BEGIN
    ...
    (1, N'2024年AI发展趋势深度解析', N'从GPT-5到AGI，全面解读人工智能的未来走向', N'人工智能正在以前所未有的速度改变我们的世界...', 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&h=450&fit=crop', 1, 0, 0.00, 15680, 892, 156, 1),
    (1, N'区块链技术在供应链中的应用实践', N'如何用区块链解决供应链信任问题', N'区块链技术正在重塑全球供应链管理...', 'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=800&h=450&fit=crop', 1, 1, 19.90, 8920, 456, 89, 1),
    (1, N'智能家居生态系统搭建指南', N'从零开始打造你的智能家居', N'想要拥有一个科技感满满的智能家居...', 'https://images.unsplash.com/photo-1558002038-1055907df827?w=800&h=450&fit=crop', 1, 0, 0.00, 12350, 678, 234, 1),
    (2, N'2024年UI设计趋势完全指南', N'掌握这些趋势，让你的设计领先一步', N'设计趋势每年都在变化...', 'https://images.unsplash.com/photo-1561070791-2526d30994b5?w=800&h=450&fit=crop', 1, 0, 0.00, 9860, 567, 123, 1),
    (2, N'Figma高级技巧：提升10倍工作效率', N'这些技巧让你的设计工作事半功倍', N'Figma已经成为设计师的必备工具...', 'https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?w=800&h=450&fit=crop', 1, 1, 29.90, 6780, 389, 78, 1),
    (2, N'设计师作品集打造完全手册', N'如何让你的作品集脱颖而出', N'一份优秀的作品集是设计师求职的敲门砖...', 'https://images.unsplash.com/photo-1558655146-9f40138edfeb?w=800&h=450&fit=crop', 1, 1, 39.90, 5420, 312, 56, 1),
    (3, N'米其林主厨的家常菜秘籍', N'用专业技巧做出不一样的家常味道', N'谁说家常菜不能有米其林的品质...', 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=800&h=450&fit=crop', 1, 0, 0.00, 28900, 1560, 345, 1),
    (3, N'完美牛排的烹饪艺术', N'从选肉到摆盘，全流程详解', N'一块完美的牛排需要精确的温度控制...', 'https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=800&h=450&fit=crop', 1, 1, 15.90, 18600, 923, 189, 1),
    (3, N'中式糕点制作入门', N'传统手艺，现代演绎', N'中式糕点承载着深厚的文化底蕴...', 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=800&h=450&fit=crop', 1, 0, 0.00, 15200, 867, 156, 1),
    (4, N'日本深度游：那些小众却惊艳的地方', N'避开人潮，发现不一样的日本', N'去过东京、大阪、京都...', 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=800&h=450&fit=crop', 1, 0, 0.00, 32500, 1890, 423, 1),
    (4, N'背包客的欧洲穷游攻略', N'用最少的钱，看最美的风景', N'欧洲旅行不一定要花大钱...', 'https://images.unsplash.com/photo-1467269204594-9661b134dd2b?w=800&h=450&fit=crop', 1, 1, 25.90, 21800, 1234, 267, 1),
    (4, N'冰岛极光摄影之旅', N'追逐北极光的完整指南', N'冰岛是观赏极光的最佳目的地之一...', 'https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=800&h=450&fit=crop', 1, 1, 35.90, 16700, 978, 189, 1),
    (5, N'人像摄影布光完全指南', N'从自然光到棚拍，全面掌握布光技巧', N'光线是摄影的灵魂...', 'https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=800&h=450&fit=crop', 1, 0, 0.00, 14500, 823, 167, 1),
    (5, N'Lightroom调色预设分享', N'10套电影感调色预设免费下载', N'调色是后期处理的关键环节...', 'https://images.unsplash.com/photo-1493863641943-9b68992a8d07?w=800&h=450&fit=crop', 1, 1, 19.90, 11200, 645, 134, 1),
    (6, N'零基础学编曲：从入门到精通', N'用FL Studio创作你的第一首歌', N'想要创作自己的音乐...', 'https://images.unsplash.com/photo-1511379938547-c1f69419868d?w=800&h=450&fit=crop', 1, 0, 0.00, 9800, 534, 98, 1),
    (6, N'混音技巧进阶：让你的作品更专业', N'专业混音师的秘密武器', N'混音是音乐制作中最关键的环节之一...', 'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=800&h=450&fit=crop', 1, 1, 49.90, 6500, 378, 67, 1);
